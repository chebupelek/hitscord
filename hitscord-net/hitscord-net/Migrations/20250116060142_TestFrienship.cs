...
{
    /// <inheritdoc />
    public partial class TestFrienship : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserFirstId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserSecondId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Friendship", x => new { x.UserFirstId, x.UserSecondId });
                    table.ForeignKey(
                        name: "FK_Friendship_User_UserFirstId",
                        column: x => x.UserFirstId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Friendship_User_UserSecondId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendshipApplication", x => new { x.UserFromId, x.UserToId });
                    table.ForeignKey(
                        name: "FK_FriendshipApplication_User_UserFromId",
                        column: x => x.UserFromId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FriendshipApplication_User_UserToId",
                        column: x => x.UserToId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friendship_UserSecondId",
                table: "Friendship",
                column: "UserSecondId");

            migrationBuilder.CreateIndex(
                name: "IX_FriendshipApplication_UserToId",
