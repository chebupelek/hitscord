...
public interface IMessageService
{
    ...
    Task CreateMessageWebsocketAsync(Guid channelId, string token, string text, Guid? ReplyToMessageId, bool NestedChannel, List<Guid>? Files);
    ...
    Task CreateMessageToChatWebsocketAsync(Guid chatId, string token, string text, Guid? ReplyToMessageId, List<Guid>? Files);
