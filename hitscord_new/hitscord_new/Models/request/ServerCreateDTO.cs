...
public class ServerCreateDTO
{
    ...
    public void Validation()
    {
        ...
        {
            throw new CustomException("Name must be between 6 and 50 characters.", "Server", "Name", 400, "Название сервера должно быть от 6 до 50 символов", "Валидация создания сервера");
        }
    }
}